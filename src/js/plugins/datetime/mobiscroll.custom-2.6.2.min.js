(function(a) {
    function m(f, c) {
        ...
        function k(c) {
            return a.isArray(p.readonly) ? (c = a(".dwwl", v).index(c),
            p.readonly[c]) : p.readonly
        }
        function y(c,name) {
            ...
            a.each(k, function(a, c) {
                ...
                g += '<div role="option" aria-selected="false" class="dw-li dw-v" data-val="' + h[a] + '"' + (y[a] ? ' aria-label="' + y[a] + '"' : "") + ' style="height:' + H + "px;line-height:" + H + 'px;"><div class="dw-i">' + c + name+ "</div></div>";
                b++
            });
            return g += "</div>"
        }
        ...
        function r(c) {
            ...
            x ? (a.each(["t", "webkitT", "MozT", "OT", "msT"], function(a, c) {
                if (void 0 !== g[c + "ransform"])
                    return b = g[c + "ransform"],
                    !1
            }),
            b = b.split(")")[0].split(", "),
            c = b[13] || b[5]) : c = g.top.replace("px", "");
        ...
        function m(a, c, g, b, y) {
            var k = (na - g) * H
              , h = a[0].style;
            k == ja[c] && ba[c] || (b && k != ja[c] && E("onAnimStart", [v, c, b]),
            ja[c] = k,
            h[D + "Transition"] = "all " + (b ? b.toFixed(3) : 0) + "s ease-out",
            x ? h[D + "Transform"] = "translate3d(0," + k + "px,0)" : h.top = k + "px",
            ba[c] && t(a, c),
            b && y && (a.closest(".dwwl").addClass("dwa"),
            ba[c] = setTimeout(function() {
                t(a, c)
            }, 1E3 * b)),
            ea[c] = g)
        }
            ...
            !1 !== E("validate", [v, g, c]) && (a(".dw-ul", v).each(function(b) {
                ...
                if (!e.hasClass("dw-v")) {
                    for (var o = e, d = 0, l = 0; 0 <= f - d && !o.hasClass("dw-v"); )
                        d++,
                        o = i.eq(f - d);
                    for (; f + l < j && !e.hasClass("dw-v"); )
                        l++,
                        e = i.eq(f + l);
                    (l < d && l && 2 !== k || !d || 0 > f - d || 1 == k) && e.hasClass("dw-v") ? f += l : (e = o,
                    f -= d)
                }
                if (!e.hasClass("dw-sel") || I)
                    n.temp[b] = e.attr("data-val"),
                    a(".dw-sel", h).removeClass("dw-sel"),
                    p.multiple || (a(".dw-sel", h).removeAttr("aria-selected"),
                    e.attr("aria-selected", "true")),
                    e.addClass("dw-sel"),
                    m(h, b, f, I ? c : 0.1, I ? y : !1)
            }),
            R = p.formatResult(n.temp),
            "inline" == p.display ? ia(b, 0, !0) : a(".dwv", v).html(d(R)),
            b && E("onChange", [R]))
        }
        function E(g, b) {
            var k;
        ...
        var na, H, R, v, S, O, ra, ca, P, sa, T, za, ka, Aa, V, fa, ta, X, Ba, U, ga, Y, Z, L, M, ha, ua, va, n = this, wa = a.mobiscroll, N = f, G = a(N), p = i({}, B), qa = {}, ba = {}, ea = {}, ja = {}, la = [], aa = G.is("input"), W = !1, Fa = function(c) {
            z(c) && !e && !k(this) && !V && (c.preventDefault(),
            e = !0,
            fa = "clickpick" != p.mode,
            L = a(".dw-ul", this),
            h(L),
            ga = (ta = void 0 !== ba[M]) ? r(L) : ea[M],
            X = A(c, "Y"),
            Ba = new Date,
            U = X,
            m(L, M, ga, 0.0010),
            fa && L.closest(".dwwl").addClass("dwa"),
            a(document).on(u, Ca).on(w, Da))
        }, Ca = function(a) {
            fa && (a.preventDefault(),
            a.stopPropagation(),
            U = A(a, "Y"),
            m(L, M, Math.max(Y - 1, Math.min(ga + (X - U) / H, Z + 1))));
            ta = !0
        }, Da = function() {
        ...
        n.position = function(c) {
            if (!("inline" == p.display || S === a(window).width() && ra === a(window).height() && c || !1 === E("onPosition", [v]))) {
                ...
                b = d > S ? l : d,
                y.width(b).css("white-space", d > S ? "" : "nowrap"));
                ca = j.outerWidth();
                P = j.outerHeight(!0);
                sa = P <= O && ca <= S;
                "modal" == p.display ? (g = (S - ca) / 2,
                k = c + (O - P) / 2) : "bubble" == p.display ? (n = !0,
                i = a(".dw-arrw-i", v),
                g = e.offset(),
                h = g.top,
                f = g.left,
                y = e.outerWidth(),
                e = e.outerHeight(),
                g = f - (j.outerWidth(!0) - y) / 2,
                g = g > S - ca ? S - (ca + 20) : g,
                g = 0 <= g ? g : 20,
                k = h - P,
                k < c || h > c + O ? (j.removeClass("dw-bubble-top").addClass("dw-bubble-bottom"),
                k = h + e) : j.removeClass("dw-bubble-bottom").addClass("dw-bubble-top"),
                i = i.outerWidth(),
                y = f + y / 2 - (g + (ca - i) / 2),
                a(".dw-arr", v).css({
                    left: Math.max(0, Math.min(y, i))
                })) : (I.width = "100%",
                "top" == p.display ? k = c : "bottom" == p.display && (k = c + O - P));
                I.top = 0 > k ? 0 : k;
                I.left = g;
                j.css(I);
            ...
            if (v) {
                ...
                a.each(p.wheels, function(e, h) {
                    a.each(h, function(e, h) {
                        if (-1 < a.inArray(b, c) && (la[b] = h,
                        a(".dw-ul", v).eq(b).html(y(b)),
                        k--,
                        !k))
                            return n.position(),
                            K(g, void 0, !0),
        ...
        n.show = function(c) {
            ...
            var b, g = 0, k = "";
            T && !c && (k = "dw-" + T + " dw-in");
            var h = '<div role="dialog" class="' + p.theme + " dw-" + p.display + (Q ? " dw" + Q : "") + '">' + ("inline" == p.display ? '<div class="dw dwbg dwi"><div class="dwwr">' : '<div class="dw-persp"><div class="dwo"></div><div class="dw dwbg ' + k + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr"><div><span class=\"dwbw dwb-c\" style=\"float:left;\"><span class=\"dwb dwb-e\" role=\"button\" tabindex=\"0\" style=\"color:#999999;\">' + p.cancelText + '</span></span><span style="color:#38c8ac;font-size:18px;line-height:44px;">选择日期</span><span class=\"dwbw dwb-s\" style=\"float:right;\"><span class=\"dwb dwb-e\" role=\"button\" tabindex=\"0\" style=\"color:#333333;\">' + p.setText + '</span></span></div>') + '<div class="dwcc">';
            a.each(p.wheels, function(c, k) {
                h += '<div style=\"width:90%\" class="dwc' + ("scroller" != p.mode ? " dwpm" : " dwsc") + (p.showLabel ? "" : " dwhl") + '"><div class="dwwc dwrc"><table cellpadding="0" cellspacing="0" style="width:100%;"><tr>';
                a.each(k, function(a, c) {
                    la[g] = c;
            ...
            K();
            E("onMarkupReady", [v]);
            "inline" != p.display ? (v.appendTo("body"),
            T && !c && (v.addClass("dw-trans"),
            setTimeout(function() {
        ...
        n.hide = function(c, b) {
            ...
            v && ("inline" != p.display && T && !c ? (v.addClass("dw-trans").find(".dw").addClass("dw-" + T + " dw-out"),
            setTimeout(function() {
                v.remove();
                v = null
            }, 350)) : (v.remove(),
    ...
    function l(a, c, b) {
        ...
        if ("object" === typeof c)
            return a.each(function() {
                this.id || (f += 1,
                this.id = "mobiscroll" + f);
                q[this.id] = new m(this,c)
            });
        "string" === typeof c && a.each(function() {
            var a;
            if ((a = q[this.id]) && a[c])
                if (a = a[c].apply(this, Array.prototype.slice.call(b, 1)),
                void 0 !== a)
                    return k = a,
                    !1
        });
    ...
    var e, j, t, s, o, f = (new Date).getTime(), q = {}, b = function() {}, r = document.createElement("modernizr").style, x = d(["perspectiveProperty", "WebkitPerspective", "MozPerspective", "OPerspective", "msPerspective"]), Q = function() {
        ...
        if (J.match(/time/i)) {
            ...
            for (o = C; o < C + 4; o++)
                if (o == w.h) {
                    ...
                    o == w.a && (C++,
                    r = g.match(/A/),
                    e(q, [0, 1], r ? ["AM", "PM"] : ["am", "pm"], i.ampmText));
            s.push(q)
        }
                        ...
                        if (d == "d") {
                            ...
                            k && a(".dw-li", q).each(function() {
                                var b = a(this)
                                  ...
                                  , g = c.replace(/[my]/gi, "").replace(/dd/, g < 10 ? "0" + g : g).replace(/d/, g);
...
(function(a) {
    var m = a.mobiscroll
      ...
      , z = function(m) {
        ...
        a("#" + Q).remove();
        b.showInput && (r = a('<input type="text" id="' + Q + '" value="" class="' + b.inputClass + '" readonly />').insertBefore(q),
        m.settings.anchor = r,
        b.showOnFocus && r.focus(function() {
            m.show()
        }),
    ...
    a.mobiscroll.presets.select = function(d) {
        ...
        function A(a, e) {
            ...
            if (t) {
                ...
                f = e ? d.values[u] : null;
            e && (b = !0,
            j.val(f).trigger("change"))
        }
        function F(a) {
            if (t && a.hasClass("dw-v") && a.closest(".dw").find(".dw-ul").index(a.closest(".dw-ul")) == u) {
                var b = a.attr("data-val");
                a.hasClass("dw-msel") ? (a.removeClass("dw-msel").removeAttr("aria-selected"),
                delete d._selectedValues[b]) : (a.addClass("dw-msel").attr("aria-selected", "true"),
